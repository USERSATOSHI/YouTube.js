...
class VideoCard extends YTNode {
  ...
  constructor(data: any) {
    ...
    const overlay_time_status =
      data.thumbnailOverlays.find(
        (overlay: any) => overlay.thumbnailOverlayTimeStatusRenderer
    ...
    this.snippets =
      data.detailedMetadataSnippets?.map((snippet: any) => ({
