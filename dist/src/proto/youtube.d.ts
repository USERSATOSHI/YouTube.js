...
declare class InnertubePayload_Title$Type extends MessageType<InnertubePayload_Title> {
    constructor();
 ...
 */
export declare const InnertubePayload_Title: InnertubePayload_Title$Type;
declare class InnertubePayload_Description$Type extends MessageType<InnertubePayload_Description> {
    constructor();
 ...
 */
export declare const InnertubePayload_Description: InnertubePayload_Description$Type;
declare class InnertubePayload_Tags$Type extends MessageType<InnertubePayload_Tags> {
    constructor();
 ...
 */
export declare const InnertubePayload_Tags: InnertubePayload_Tags$Type;
declare class InnertubePayload_Privacy$Type extends MessageType<InnertubePayload_Privacy> {
    constructor();
 ...
 */
export declare const InnertubePayload_Privacy: InnertubePayload_Privacy$Type;
declare class InnertubePayload_Category$Type extends MessageType<InnertubePayload_Category> {
    constructor();
 ...
 */
export declare const InnertubePayload_Category: InnertubePayload_Category$Type;
declare class InnertubePayload_MadeForKids$Type extends MessageType<InnertubePayload_MadeForKids> {
    constructor();
 ...
 */
export declare const InnertubePayload_MadeForKids: InnertubePayload_MadeForKids$Type;
declare class InnertubePayload_AgeRestricted$Type extends MessageType<InnertubePayload_AgeRestricted> {
    constructor();
 ...
 */
export declare const InnertubePayload_AgeRestricted: InnertubePayload_AgeRestricted$Type;
declare class InnertubePayload_License$Type extends MessageType<InnertubePayload_License> {
    constructor();
 ...
 */
export declare const InnertubePayload_License: InnertubePayload_License$Type;
declare class InnertubePayload_VideoThumbnail$Type extends MessageType<InnertubePayload_VideoThumbnail> {
    constructor();
 ...
 */
export declare const InnertubePayload_VideoThumbnail: InnertubePayload_VideoThumbnail$Type;
declare class InnertubePayload_VideoThumbnail_Thumbnail$Type extends MessageType<InnertubePayload_VideoThumbnail_Thumbnail> {
    constructor();
 ...
 */
export declare const InnertubePayload_VideoThumbnail_Thumbnail: InnertubePayload_VideoThumbnail_Thumbnail$Type;
