...
class Comments {
    ...
    createComment(text) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.header)
                throw new Utils_1.InnertubeError('Page header is missing. Cannot create comment.');
            const button = (_b = (_a = this.header.create_renderer) === null || _a === void 0 ? void 0 : _a.as(CommentSimplebox_1.default).submit_button) === null || _b === void 0 ? void 0 : _b.item().as(Button_1.default);
            if (!button)
                throw new Utils_1.InnertubeError('Could not find target button. You are probably not logged in.');
