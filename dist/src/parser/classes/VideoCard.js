...
class VideoCard extends helpers_1.YTNode {
    constructor(data) {
        var _a, _b, _c, _d;
        super();
        const overlay_time_status = ((_a = data.thumbnailOverlays.find((overlay) => overlay.thumbnailOverlayTimeStatusRenderer)) === null || _a === void 0 ? void 0 : _a.thumbnailOverlayTimeStatusRenderer.text) || 'N/A';
        this.id = data.videoId;
        this.title = new Text_1.default(data.title);
        this.description_snippet = data.descriptionSnippet
            ? new Text_1.default(data.descriptionSnippet)
            : null;
        this.snippets =
            ((_b = data.detailedMetadataSnippets) === null || _b === void 0 ? void 0 : _b.map((snippet) => ({
        ...
        this.rich_thumbnail = data.richThumbnail
            ? index_1.default.parse(data.richThumbnail)
            : null;
        ...
        this.duration = {
            text: data.lengthText
                ? new Text_1.default(data.lengthText).text
                : new Text_1.default(overlay_time_status).text,
            seconds: (0, Utils_1.timeToSeconds)(data.lengthText
                ? new Text_1.default(data.lengthText).text
                : new Text_1.default(overlay_time_status).text)
        };
