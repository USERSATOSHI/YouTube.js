...
class CommentThread extends helpers_1.YTNode {
    ...
    getReplies() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (continuation === null || continuation === void 0 ? void 0 : continuation.endpoint.call(__classPrivateFieldGet(this, _CommentThread_actions, "f"), { parse: true }));
    ...
    getContinuation() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!__classPrivateFieldGet(this, _CommentThread_actions, "f"))
                throw new Utils_1.InnertubeError('Actions not set for this CommentThread.');
            const response = yield ((_a = __classPrivateFieldGet(this, _CommentThread_continuation, "f").button) === null || _a === void 0 ? void 0 : _a.item().key('endpoint').nodeOfType(NavigationEndpoint_1.default).call(__classPrivateFieldGet(this, _CommentThread_actions, "f"), { parse: true }));
