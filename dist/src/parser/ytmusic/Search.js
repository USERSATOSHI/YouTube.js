    ...
    selectFilter(name) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter === null || filter === void 0 ? void 0 : filter.is_selected)
                return this;
            const response = yield ((_d = filter === null || filter === void 0 ? void 0 : filter.endpoint) === null || _d === void 0 ? void 0 : _d.call(__classPrivateFieldGet(this, _Search_actions, "f"), { parse: true, client: 'YTMUSIC' }));
            if (!response)
                throw new Utils_1.InnertubeError('Endpoint did not return any data');
            return new Search(response, __classPrivateFieldGet(this, _Search_actions, "f"), { is_continuation: true });
        });
