...
class Playlist {
    constructor(response, actions) {
        ...
        if (__classPrivateFieldGet(this, _Playlist_page, "f").continuation_contents) {
            const data = (_a = __classPrivateFieldGet(this, _Playlist_page, "f").continuation_contents) === null || _a === void 0 ? void 0 : _a.as(index_1.MusicPlaylistShelfContinuation);
            ...
            if (((_b = __classPrivateFieldGet(this, _Playlist_page, "f").header) === null || _b === void 0 ? void 0 : _b.item().type) === 'MusicEditablePlaylistDetailHeader') {
                this.header = (_c = __classPrivateFieldGet(this, _Playlist_page, "f").header) === null || _c === void 0 ? void 0 : _c.item().as(MusicEditablePlaylistDetailHeader_1.default).header.item().as(MusicDetailHeader_1.default);
            }
            else {
                this.header = ((_d = __classPrivateFieldGet(this, _Playlist_page, "f").header) === null || _d === void 0 ? void 0 : _d.item().as(MusicDetailHeader_1.default)) || null;
            }
            this.items = (_e = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(MusicPlaylistShelf_1.default)) === null || _e === void 0 ? void 0 : _e[0].contents;
            __classPrivateFieldSet(this, _Playlist_continuation, ((_f = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(MusicPlaylistShelf_1.default)) === null || _f === void 0 ? void 0 : _f[0].continuation) || null, "f");
        }
    }
    /**
    ...
    getRelated() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (section_continuation) {
                ...
                const sections = (_c = section_list === null || section_list === void 0 ? void 0 : section_list.contents) === null || _c === void 0 ? void 0 : _c.as(MusicCarouselShelf_1.default, MusicShelf_1.default);
                const related = sections === null || sections === void 0 ? void 0 : sections.filter((section) => {
                    var _a;
                    return section.is(MusicCarouselShelf_1.default) ? ((_a = section.header) === null || _a === void 0 ? void 0 : _a.title.toString()) === 'Related playlists' :
...
_Playlist_page = new WeakMap(), _Playlist_actions = new WeakMap(), _Playlist_continuation = new WeakMap(), _Playlist_last_fetched_suggestions = new WeakMap(), _Playlist_suggestions_continuation = new WeakMap(), _Playlist_instances = new WeakSet(), _Playlist_fetchSuggestions = function _Playlist_fetchSuggestions() {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const continuation = __classPrivateFieldGet(this, _Playlist_suggestions_continuation, "f") || ((_a = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.get('SectionList')) === null || _a === void 0 ? void 0 : _a[0].as(SectionList_1.default).continuation);
        if (continuation) {
            ...
            const section_list = (_b = page.continuation_contents) === null || _b === void 0 ? void 0 : _b.as(index_1.SectionListContinuation);
            const sections = (_c = section_list === null || section_list === void 0 ? void 0 : section_list.contents) === null || _c === void 0 ? void 0 : _c.as(MusicCarouselShelf_1.default, MusicShelf_1.default);
            const suggestions = sections === null || sections === void 0 ? void 0 : sections.filter((section) => section.is(MusicShelf_1.default) && section.title.toString() === 'Suggestions')[0];
            return {
