...
class Album {
    constructor(response, actions) {
        ...
        this.header = (_a = __classPrivateFieldGet(this, _Album_page, "f").header) === null || _a === void 0 ? void 0 : _a.item().as(MusicDetailHeader_1.default);
        this.url = ((_b = __classPrivateFieldGet(this, _Album_page, "f").microformat) === null || _b === void 0 ? void 0 : _b.as(MicroformatData_1.default).url_canonical) || null;
        this.contents = (_c = __classPrivateFieldGet(this, _Album_page, "f").contents_memo.get('MusicShelf')) === null || _c === void 0 ? void 0 : _c[0].as(MusicShelf_1.default).contents;
