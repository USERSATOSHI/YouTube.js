...
class Recap {
    constructor(response, actions) {
        ...
        this.header = (header === null || header === void 0 ? void 0 : header.is(MusicElementHeader_1.default)) ?
            (_d = (_c = (_b = __classPrivateFieldGet(this, _Recap_page, "f").header) === null || _b === void 0 ? void 0 : _b.item().as(MusicElementHeader_1.default).element) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.item().as(HighlightsCarousel_1.default) :
            (_e = __classPrivateFieldGet(this, _Recap_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicHeader_1.default);
        ...
        this.sections = (_f = tab.content) === null || _f === void 0 ? void 0 : _f.as(SectionList_1.default).contents.array().as(ItemSection_1.default, MusicCarouselShelf_1.default, Message_1.default);
    }
    /**
