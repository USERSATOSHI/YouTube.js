...
const CarouselItem_1 = __importDefault(require("./classes/CarouselItem"));
...
const CompactStation_1 = __importDefault(require("./classes/CompactStation"));
const CompactVideo_1 = __importDefault(require("./classes/CompactVideo"));
const ConfirmDialog_1 = __importDefault(require("./classes/ConfirmDialog"));
...
const DefaultPromoPanel_1 = __importDefault(require("./classes/DefaultPromoPanel"));
...
const GameCard_1 = __importDefault(require("./classes/GameCard"));
const GameDetails_1 = __importDefault(require("./classes/GameDetails"));
...
const LiveChatTickerPaidStickerItem_1 = __importDefault(require("./classes/livechat/items/LiveChatTickerPaidStickerItem"));
...
const RemoveChatItemAction_1 = __importDefault(require("./classes/livechat/RemoveChatItemAction"));
const RemoveChatItemByAuthorAction_1 = __importDefault(require("./classes/livechat/RemoveChatItemByAuthorAction"));
...
const MetadataScreen_1 = __importDefault(require("./classes/MetadataScreen"));
...
const PlaylistCustomThumbnail_1 = __importDefault(require("./classes/PlaylistCustomThumbnail"));
...
const RecognitionShelf_1 = __importDefault(require("./classes/RecognitionShelf"));
...
const ThumbnailLandscapePortrait_1 = __importDefault(require("./classes/ThumbnailLandscapePortrait"));
...
const TopicChannelDetails_1 = __importDefault(require("./classes/TopicChannelDetails"));
...
const VideoCard_1 = __importDefault(require("./classes/VideoCard"));
...
exports.YTNodes = {
    ...
    CarouselHeader: CarouselHeader_1.default,
    ...
    CompactStation: CompactStation_1.default,
    CompactVideo: CompactVideo_1.default,
    ConfirmDialog: ConfirmDialog_1.default,
    ...
    DefaultPromoPanel: DefaultPromoPanel_1.default,
    ...
    GameCard: GameCard_1.default,
    GameDetails: GameDetails_1.default,
    Grid: Grid_1.default,
    ...
    InteractiveTabbedHeader: InteractiveTabbedHeader_1.default,
    ...
    LiveChatTickerPaidStickerItem: LiveChatTickerPaidStickerItem_1.default,
    ...
    RemoveChatItemByAuthorAction: RemoveChatItemByAuthorAction_1.default,
    ...
    MetadataScreen: MetadataScreen_1.default,
    ...
    PlaylistCustomThumbnail: PlaylistCustomThumbnail_1.default,
    ...
    RecognitionShelf: RecognitionShelf_1.default,
    ...
    ThumbnailLandscapePortrait: ThumbnailLandscapePortrait_1.default,
    ...
    TopicChannelDetails: TopicChannelDetails_1.default,
