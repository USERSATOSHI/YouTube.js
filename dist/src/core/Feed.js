...
const ReelItem_1 = __importDefault(require("../parser/classes/ReelItem"));
class Feed {
    constructor(actions, data, already_parsed = false) {
        ...
        const memo = (0, Utils_1.concatMemos)(__classPrivateFieldGet(this, _Feed_page, "f").contents_memo, __classPrivateFieldGet(this, _Feed_page, "f").on_response_received_commands_memo, __classPrivateFieldGet(this, _Feed_page, "f").on_response_received_endpoints_memo, __classPrivateFieldGet(this, _Feed_page, "f").on_response_received_actions_memo, __classPrivateFieldGet(this, _Feed_page, "f").sidebar_memo, __classPrivateFieldGet(this, _Feed_page, "f").header_memo);
        if (!memo)
